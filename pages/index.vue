  ...
  <div class="">
    ...
    <div class="container mt-5">
      <form class="mb-5 mt-0" @submit.prevent="createScheduler">
        ...
        <b-form-input
          v-model="vestedSchd._beneficiary"
        ...
        <b-button
          type="submit"
          class="btn-classes-active update-btn mt-5 bg-info"
          block
        >
          {{ crud ? "Sending" : "Submit" }}
        </b-button>
...
export default {
  setup() {
    ...
    const createScheduler = async () => {
      ...
      const duration =
        Math.abs(new Date(startDate.value) - new Date(endDate.value)) / 1000;
      ...
      try {
        const result = await contract?.value?.createVestingSchedule(
          _beneficiary,
          _start,
          cliff,
          _duration,
